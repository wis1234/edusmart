...
<div class="container mx-auto px-4">
    <h1 class="text-2xl font-bold mb-4">Add New Parent</h1>
    ...
    <form action="{{ route('parents.store') }}" method="POST" class="max-w-lg">
        @csrf
        ...
        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add Parent</button>
    </form>
</div>
@endsection
