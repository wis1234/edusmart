        ...
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-300">Update information for {{ $student->first_name }} {{ $student->last_name }}</p>
                </div>
            </div>
            ...
            <form action="{{ route('students.update', $student) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="first_name" name="first_name" value="{{ old('first_name', $student->first_name) }}" required maxlength="255"
                    ...
                    <div>
                        ...
                        <input type="text" id="last_name" name="last_name" value="{{ old('last_name', $student->last_name) }}" required maxlength="255"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="date" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $student->date_of_birth ? $student->date_of_birth->format('Y-m-d') : '') }}" required
                    ...
                    <div>
                        ...
                        @if($student->profile_photo_url)
                            <div class="mb-2">
                                <img src="{{ $student->profile_photo_url }}" alt="Profile Photo" class="w-32 h-32 rounded-lg object-cover border-2 border-gray-200 dark:border-gray-600">
                            </div>
                        @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="class_room_id" name="class_room_id" data-current="{{ old('class_room_id', $student->class_room_id) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="admission_date" name="admission_date" value="{{ old('admission_date', $student->admission_date ? $student->admission_date->format('Y-m-d') : '') }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="admission_number" name="admission_number" value="{{ old('admission_number', $student->admission_number) }}" required maxlength="255" readonly
                    ...
                    <div>
                        ...
                        <input type="text" id="roll_number" name="roll_number" value="{{ old('roll_number', $student->roll_number) }}" readonly
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="blood_group" name="blood_group" value="{{ old('blood_group', $student->blood_group) }}"
                ...
                <div>
                    ...
                    <textarea id="medical_conditions" name="medical_conditions" rows="3"
                        class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500 @error('medical_conditions') border-red-500 @enderror">{{ old('medical_conditions', $student->medical_conditions) }}</textarea>
