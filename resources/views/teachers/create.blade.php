...
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-4">
        <a href="{{ route('teachers.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded">← Back to Teachers</a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="mb-4 col-span-2">
                ...
                <textarea name="address" id="address" rows="3" 
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500" required>{{ old('address') }}</textarea>
            </div>
            ...
            <div class="mb-4 col-span-2">
                ...
                <input type="text" name="speciality" id="speciality" value="{{ old('speciality') }}" 
                    class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-blue-500" required>
            </div>
